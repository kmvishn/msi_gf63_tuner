...
public enum Response
{
    ...
    ReadResult,
    /// <summary>
    /// The result of a <see cref="Command.GetFanSpeeds"/> command.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This response's <see cref="ServiceResponse.Value"/> field includes
    ...
    FanSpeeds,
    /// <summary>
    /// The result of a <see cref="Command.GetFanRPMs"/> command.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This response's <see cref="ServiceResponse.Value"/> field includes
    /// the following data as an <see langword="int"/> array:<br/>
    /// • RPM: The RPM of up to 4 fans in the system (depending on
    /// which ones are present in the system), with a value of -1
    /// for all fans that are not present or turned off.
    /// </para>
    /// </remarks>
    FanRPMs,
    /// <summary>
    /// The result of a <see cref="Command.GetTemps"/> command.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This response's <see cref="ServiceResponse.Value"/> field includes
