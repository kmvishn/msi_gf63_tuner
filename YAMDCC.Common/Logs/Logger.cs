...
public sealed class Logger : IDisposable
{
    ...
    public void Debug(string msg, string module = null)
    {
        ...
        {
            LogConsole(msg, module, LogLevel.Debug);
        }
    }
    ...
    public void Info(string msg, string module = null)
    {
        ...
        {
            LogConsole(msg, module, LogLevel.Info);
        }
    }
    ...
    public void Warn(string msg, string module = null)
    {
        ...
        {
            LogConsole(msg, module, LogLevel.Warn);
        }
    }
    ...
    public void Error(string msg, string module = null)
    {
        ...
        {
            LogConsole(msg, module, LogLevel.Error);
        }
    }
    ...
    public void Fatal(string msg, string module = null)
    {
        ...
        {
            LogConsole(msg, module, LogLevel.Fatal);
        }
    }

    private static string LogString(string str, LogLevel level, string module, bool date)
    {
        return $"{(date ? $"[{DateTime.Now:dd/MM/yyyy HH:mm:ss.fff}] " : "")}{$"[{level}]",-8}{(module is null ? "" : $"[{module}] ")}{str}";
    }
    ...
    private void LogFile(string msg, string module, LogLevel level)
    {
        ...
        lock (LogWriter)
        {
            ...
            {
                LogWriter.WriteLine(LogString(str, level, module, TimeToFile));
            }
        }
    }

    private void LogConsole(string msg, string module, LogLevel level)
    {
        if (msg is null)
        {
            return;
        ...
        lock (conLock)
        {
            ...
            foreach (string str in msg.Split(NewLine, StringSplitOptions.RemoveEmptyEntries))
            {
                Console.WriteLine(LogString(str, level, module, TimeToConsole));
            }
